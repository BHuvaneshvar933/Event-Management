...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('https://event-backend-utqn.onrender.com/api/auth/login', {
        method: 'POST',
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#ff385c]/10 blur-[120px] rounded-full"></div>
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-5xl font-black uppercase italic tracking-tighter mb-2">Welcome Back</h1>
          <p className="text-gray-500 font-bold uppercase tracking-widest text-xs">Enter the District</p>
        </div>
